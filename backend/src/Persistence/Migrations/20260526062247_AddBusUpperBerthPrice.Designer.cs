...
namespace TravelPort.Persistence.Migrations
{
    ...
    [Migration("20260526062247_AddBusUpperBerthPrice")]
    partial class AddBusUpperBerthPrice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelPort.Domain.Entities.Announcement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TravelPort.Domain.Entities.Bus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal?>("UpperBerthPrice")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("TravelPort.Domain.Entities.Flight", b =>
                {
                    ...
                    b.Property<string>("LayoverAirport")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");

                    b.Property<int?>("LayoverDurationMinutes")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelPort.Domain.Entities.HotelBookingCharge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TravelPort.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TravelPort.Domain.Entities.PriceAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TravelPort.Domain.Entities.Bus", b =>
                {
                    b.HasOne("TravelPort.Domain.Entities.BusCompany", "BusCompany")
                        .WithMany()
